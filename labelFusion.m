...
cellPathsLabels = {'~/data/synthetic_brains_t1/brain1.synthetic.t1.0.6.corrected.labels.nii.gz';
    '~/data/synthetic_brains_t1/brain2.synthetic.t1.0.6.corrected.labels.nii.gz';
    '~/data/synthetic_brains_t1/brain3.synthetic.t1.0.6.corrected.labels.nii.gz';
    '~/data/synthetic_brains_t1/brain4.synthetic.t1.0.6.corrected.labels.nii.gz';
    '~/data/synthetic_brains_t1/brain5.synthetic.t1.0.6.corrected.labels.nii.gz'};
