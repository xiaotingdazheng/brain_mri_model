...
for l=1:length(labelsList)
    ...
    computeLogOdds(mask, brainMask, temp_path, LabelsMRI, rho, threshold, erode)
end
...
computeLogOdds(maskHippo, brainMask, temp_path, LabelsMRI, rho, threshold, erode)
...
computeLogOdds(maskNonHippo, brainMask, temp_path, LabelsMRI, rho, threshold, erode)
