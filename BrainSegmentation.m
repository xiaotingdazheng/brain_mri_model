...
pathDirTestImages= {'~/data/CobraLab/label_fusions/multi_channel/synth_leaveOneOutNew/test_images_t1'...
    '~/data/CobraLab/label_fusions/multi_channel/synth_leaveOneOutNew/test_images_t2'};
% cell paths test first labels (FS labels)
pathDirRefFirstLabels= {'~/data/CobraLab/label_fusions/multi_channel/synth_leaveOneOutNew/test_first_labels_t1' ...
    '~/data/CobraLab/label_fusions/multi_channel/synth_leaveOneOutNew/test_first_labels_t2'};
% cell paths test labels
pathDirTestLabels = '~/data/CobraLab/label_fusions/multi_channel/synth_leaveOneOutNew/test_labels';
% cell paths training labels
pathDirTrainingLabels = '~/data/CobraLab/label_fusions/multi_channel/synth_leaveOneOutNew/training_labels';
% path labels table
pathClassesTable= '~/data/CobraLab/label_fusions/multi_channel/synth_leaveOneOutNew/classesTable.txt';
% optional paths
% pathDirTrainingImages = {'~/data/test/real/training_images_t1' '~/data/test/real/training_images_t2'};

% experiment title
title = 'multi channel label fusion on images synthetised from CobraLab data';
% general parameters
