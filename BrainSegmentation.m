...
pathDirTestImages= '~/data/CobraLab/label_fusions/brains_t1/synth_leaveOneOut/test_images_t1';
% cell paths test first labels (FS labels)
pathDirRefFirstLabels= '~/data/CobraLab/label_fusions/brains_t1/synth_leaveOneOut/test_first_labels_t1';
% cell paths test labels
pathDirTestLabels = '~/data/CobraLab/label_fusions/brains_t1/synth_leaveOneOut/test_labels';
% cell paths training labels
pathDirTrainingLabels = '~/data/CobraLab/label_fusions/brains_t1/synth_leaveOneOut/training_labels';
% path labels table
pathClassesTable= '~/data/CobraLab/label_fusions/brains_t1/synth_leaveOneOut/classesTable.txt';
% optional paths
...
alignTestImages = 0;         % align multi-channel test images, (0=no, 1=rigid reg, 2=rl)
