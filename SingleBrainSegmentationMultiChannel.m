function SingleBrainSegmentationMultiChannel(pathRefImaget1, pathRefImaget2, ...
    pathRefLabels, ...
    pathRefFirstLabelst1, pathRefFirstLabelst2,  ...
    pathDirTrainingLabels, ...
    pathDirTrainingImages1, pathDirTrainingImages2, ...
    pathClassesTable, ...
...
pathDirTrainingImages = {pathDirTrainingImages1 pathDirTrainingImages2};
